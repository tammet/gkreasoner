...
The measured query, `flies(b1)`, is independent of the recursive ancestor
relation included in the input.
...
old run on this recursive program also did not finish.
